      ...
      <div className="grid grid-2-columns">
        <div className="communities">
          ...
          <p>
            ...
            Additionally, sharing work within the community offers validation
            and encouragement, <strong>boosting confidence and morale</strong>.
            Ultimately, inspiration and a supportive community serve as
            catalysts for growth, collaboration, and personal development in the
            journey of every 3D artist. So we think it's a pretty good idea to{" "}
            <strong>get plugged in!</strong>
          </p>
          <p>
            So, here are some places you can find other Blender enthusiasts:
          </p>
          <ul>
            <li>
              <a
        ...
        <div className="artists">
          ...
          <div className="grid grid-3-columns">
            <div className="artist-button">Button</div>
          </div>
        </div>
      </div>
    </div>
